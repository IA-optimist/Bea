...
echo "=== BEAMAX API KEYS CONFIGURATION ==="
echo ""
...
echo "3. Run: docker cp $ENV_FILE bea_core:/app/.env"
echo "4. Run: docker restart bea_core"
echo ""
...
echo "  - OR rely on Ollama (already running in bea_ollama container)"

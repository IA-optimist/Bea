...
> Honest per-component maturity rating. Last verified: **2026-06-24**, branch `feat/principal-auth-binding` (continuation of `fix/policy-engine-session-hardening`).

...
Audit S8 (2026-05-20, issue #15): moved from `core/_legacy/orchestrator_v2.py`
back to `core/orchestrator_v2.py`. The file had been mis-classified as
legacy ; in reality it is active runtime code that MetaOrchestrator
lazy-imports. The shim that lived here previously (`from core._legacy
import *`) is gone, and the import path matches what the 3 call sites
already use.
"""
from __future__ import annotations

# Audit S8 (2026-05-20): silent logger for suppressed exceptions — matches
# the pattern used across core/orchestration/. Previously this module sat

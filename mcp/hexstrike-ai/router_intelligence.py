"""
HexStrike Intelligence Router — Flask Blueprint for /api/intelligence endpoints.

Extrait depuis hexstrike_server.py. Monté via app.register_blueprint(intelligence_bp).
"""
...
from attack_intelligence import IntelligentDecisionEngine
...
__all__ = ["intelligence_bp", "decision_engine"]

"""
HexStrike Bugbounty Router — Flask Blueprint for /api/bugbounty endpoints.

Extrait depuis hexstrike_server.py. Monté via app.register_blueprint(bugbounty_bp).
"""

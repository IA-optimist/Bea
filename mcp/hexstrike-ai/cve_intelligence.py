"""
HexStrike CVE Intelligence — CVE lookup + correlation + exploit mapping.

Extrait depuis hexstrike_server.py. Classe autonome (0 external deps)
qui gère la CVE database, la corrélation vulnérabilité→exploit, et
l'intégration Shodan/Censys.
...
__all__ = ["CVEIntelligenceManager"]

"""
HexStrike CTF Router — Flask Blueprint for CTF workflow endpoints.

Extrait depuis hexstrike_server.py (Phase O) : 7 endpoints domaine CTF.
Le serveur mount via `app.register_blueprint(ctf_bp)`.

Classes dépendances (singletons locaux) :
...
from ctf import (CTFWorkflowManager, CTFToolManager,
...
# Singletons déplacés depuis hexstrike_server.py.
...
__all__ = ["ctf_bp", "ctf_manager", "ctf_tools", "ctf_automator", "ctf_coordinator"]

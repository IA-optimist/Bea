"""
HexStrike Vuln_Intel Router — Flask Blueprint for /api/vuln-intel endpoints.

Extrait depuis hexstrike_server.py. Monté via app.register_blueprint(vuln_intel_bp).
"""
...
from command_execution import AIExploitGenerator, VulnerabilityCorrelator
from cve_intelligence import CVEIntelligenceManager
...
__all__ = ["vuln_intel_bp", "cve_intelligence", "exploit_generator", "vulnerability_correlator"]

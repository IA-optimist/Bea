"""
HexStrike Error_Handling Router — Flask Blueprint for /api/error-handling endpoints.

Extrait depuis hexstrike_server.py. Monté via app.register_blueprint(error_handling_bp).
"""
...
from error_handling import GracefulDegradation, IntelligentErrorHandler
...
__all__ = ["error_handling_bp", "degradation_manager", "error_handler"]

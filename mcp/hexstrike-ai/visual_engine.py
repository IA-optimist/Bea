"""
Visual Engine — HexStrike output formatting.

Extrait depuis hexstrike_server.py (17 290 lignes) pour isoler la classe
autonome de formatage terminal (COLORS ANSI + helpers de rendu).
Backward-compat : `from .visual_engine import ModernVisualEngine`.
"""

...
def nuclei_handler(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    TODO: Extract implementation from hexstrike_server.py::nuclei()
    ...
    command = f"nuclei {options} {target}"

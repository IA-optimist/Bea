...
- `scripts/private_beta_gate.py --json` failed because the script is absent on
  the current commit.
...
- HUMAN_REQUIRED: decide whether the missing `scripts/private_beta_gate.py`
  should be restored or removed from release docs.
